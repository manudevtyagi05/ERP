...
function Reports() {
  ...
  return (
    <div className="flex flex-col gap-6">
      {/* Header */}
      <div>
        <h1 className="text-xl font-bold text-slate-800 tracking-tight !mb-0">Reports & Analytics</h1>
      ...
      <Row gutter={[16, 16]}>
        <Col xs={24} sm={12} lg={6}>
          <Card bordered={false} className="shadow-sm border border-slate-200/80">
            ...
            <p className="text-[11px] text-slate-400 mt-2">{stats.completedCount} of {stats.totalIssuesCount} issues resolved</p>
          </Card>
        </Col>
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card bordered={false} className="shadow-sm border border-slate-200/80">
            ...
            <p className="text-[11px] text-slate-400 mt-2">Completed vs. total story points</p>
          </Card>
        </Col>
        ...
        <Col xs={24} sm={12} lg={6}>
          <Card bordered={false} className="shadow-sm border border-slate-200/80">
            ...
            <p className="text-[11px] text-slate-400 mt-2">Backlog and to-do issues</p>
          </Card>
        </Col>
      ...
      <Row gutter={[20, 20]}>
        ...
        <Col xs={24} lg={12}>
          <Card
            ...
            title={<span className="text-sm font-semibold text-slate-800">Issue Status Distribution</span>}
          >
        ...
        <Col xs={24} lg={12}>
          <Card
            bordered={false}
            className="shadow-sm border border-slate-200/80"
            title={<span className="text-sm font-semibold text-slate-800">Priority Breakdown</span>}
          >
            <div className="flex flex-col gap-4">
        ...
        <Col xs={24}>
          <Card
            bordered={false}
            className="shadow-sm border border-slate-200/80"
            title={<span className="text-sm font-semibold text-slate-800">Team Workload Distribution</span>}
          >
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {teamMembers.map((member) => {
                ...
                return (
                  <div
                    key={member.id}
                    className="p-3.5 rounded-lg border border-slate-100 bg-slate-50/50 flex flex-col gap-2"
                  >
                    ...
                    <div className="flex items-center justify-between text-[11px] text-slate-500 mt-1">
                      ...
                      <span className="text-emerald-600 font-medium">{completedIssues} completed</span>
                    </div>
                  </div>
                );
              })}
